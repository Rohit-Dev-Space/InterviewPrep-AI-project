const questionAnswerPrompt = (role, topicsToFocus, experience, NumberofQuestions) => (
...
- Provide a detailed and insightful answer to each interview question based on the user's background.
...
Important: Do not include any additional text outside of the JSON array.`
)
